...
#######################################################################################################################
    ...
    def _gen_embed(self):
        ...
        e = discord.Embed()
        e.colour = 7506394
        e.set_footer(text='Made By Tess', icon_url='https://cdn.discordapp.com/attachments/407448570657243137/509023795990757377/Photo_Profile.png')
        e.set_author(name=self.user.name, url='https://cdn.discordapp.com/attachments/407448570657243137/509023795990757377/Photo_Profile.png', icon_url=self.user.avatar_url)
        return e
